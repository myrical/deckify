...
const TABS: Array<{ id: PlatformView; label: string; icon: React.ReactNode; color: string }> = [
  {
    id: "aggregate",
    label: "All",
        ...
        return (
          <button
            ...
            style={{
              ...
              color: isActive ? tab.color : isConnected ? "var(--text-secondary)" : "var(--text-tertiary)",
          ...
          >
            ...
            {isActive && (
              <div
                className="absolute inset-x-0 bottom-0 mx-auto h-0.5 w-6 rounded-full"
